export default {
    ...
    SETTING_PARAGRAPHS_DESC: "Границы абзацев внутри одного выделения определяются по вёрстке страницы: отступ первой строки, укороченная последняя строка и увеличенный интервал между строками. Выберите, чем разделять найденные абзацы.",
    OPTION_PARAGRAPHS_BLANK: "Пустой строкой",
    OPTION_PARAGRAPHS_BREAK: "Переносом строки",
    OPTION_PARAGRAPHS_NONE: "Не разделять: весь текст одним абзацем",
