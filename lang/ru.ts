export default {
    ...
    // ─── Changelog ───────────────────────────────────────────────────────────────
    // Номер версии дописывается ссылкой сразу за этой строкой, поэтому она
    // кончается пробелом и не имеет своего знака препинания.
    ...
    SETTING_FOOTNOTES_DESC: "Надстрочные знаки будут записываться как ссылки на сноски вида [^8].",
